...
GRANT EXECUTE ON FUNCTION public.inbox_list_conversations(uuid,text,uuid[],boolean,uuid[],boolean,uuid[],boolean,uuid[],text,text,timestamp with time zone,integer,text[],uuid[],uuid[],uuid[],uuid[]) TO authenticated, service_role;
...
GRANT EXECUTE ON FUNCTION public.inbox_count_conversations(uuid,uuid[],boolean,uuid[],boolean,uuid[],boolean,uuid[],text,text,text[],uuid[],uuid[],uuid[],uuid[]) TO authenticated, service_role;